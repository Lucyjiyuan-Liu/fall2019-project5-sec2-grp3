...
```{r}
load('../output/injury_PlayKey.RData') 
load('../output/non_injury_new.RData') 
...
save(injury_PlayKey_summarize, file="../output/injury_PlayKey_summarize.RData")
...
save(non_injury_summarize, file="../output/non_injury_summarize.RData")
